        ...
        <div className="flex flex-col lg:flex-row justify-between items-start gap-6 md:gap-8 lg:gap-32">
          ...
          <div className="flex-shrink-0">
            <Image
              ...
              className="w-[150px] md:w-[180px] lg:w-[200px] h-auto mb-4 md:mb-6 lg:mb-0"
            />
          </div>
          ...
          <div className="flex flex-col space-y-4">
            ...
            <div className="flex flex-row lg:flex-col space-x-3 lg:space-x-0 space-y-0 lg:space-y-2">
            ...
            <div key={index} className="flex flex-col space-y-4">
              ...
              {'contact' in section && section.contact && (
                <div className="flex flex-col space-y-3">
                  ...
                  <div className="flex items-center space-x-2 text-neutral-dark-grey" style={{ color: '#f0f0f0' }}>
                    <Image
                      src="/images/icon-6.webp"
                      alt="Email"
                      width={16}
