        ...
        <div className="flex items-center justify-center gap-3 sm:gap-4 md:gap-8 lg:gap-12 animate-fade-in">
          ...
          <div className="flex items-center gap-1 sm:gap-1.5 md:gap-2">
            ...
            <p className="text-[10px] sm:text-[11px] md:text-sm font-bold text-white whitespace-nowrap">
              <CountUp end={1000} duration={2} suffix="+" className="text-[#ffaf02]" /> Assinantes
            </p>
          </div>
          ...
          <div className="flex items-center gap-1 sm:gap-1.5 md:gap-2">
            ...
            <span className="text-[10px] sm:text-[11px] md:text-sm font-bold text-white whitespace-nowrap">2-5x mais Lucro</span>
          </div>
          ...
          <div className="flex items-center gap-1 sm:gap-1.5 md:gap-2">
            ...
            <span className="text-[10px] sm:text-[11px] md:text-sm font-bold text-white whitespace-nowrap">Suporte #1 do Mercado</span>
          </div>
        </div>
      </div>
    </section>
