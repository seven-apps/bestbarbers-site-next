      ...
      <div className="container-custom">
        <div className="flex flex-col items-center justify-center w-full space-y-12">
          ...
          <div className="text-center mb-8">
            <h2 className="text-2xl lg:text-3xl font-medium leading-normal text-white text-center whitespace-pre-line">
          ...
          <div className="flex flex-col lg:flex-row items-start justify-between gap-8 lg:gap-16 w-full">
            {/* Lista de passos */}
            <div className="flex-1 w-full lg:w-1/2 space-y-3">
              {steps.items.map((step, index) => (
                <div key={index} className="flex items-start space-x-6">
                  {/* Número do passo */}
                  <div className="flex-shrink-0 w-12 h-12 bg-primary rounded-full flex items-center justify-center" style={{ backgroundColor: '#ffaf02' }}>
                    <span className="text-xl font-black text-neutral-bg2">
                      {step.number}
                    </span>
                  </div>
            ...
            <div className="flex-1 w-full lg:w-1/2 flex justify-center lg:justify-end">
              <Image
                ...
                className="w-full h-auto max-w-[80%] lg:max-w-full object-contain"
