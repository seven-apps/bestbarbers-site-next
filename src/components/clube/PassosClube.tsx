...
interface PassosClubeProps {
  onCtaClick: () => void;
}

/**
 * Clone da StepsSection da homepage para /clube (mockup Seletto).
 * Os 5 passos reais + camada leve para quem já tem clube.
 * originDesc: [Site-Clube]BT-Passos.
 */
export function PassosClube({ onCtaClick }: PassosClubeProps) {
