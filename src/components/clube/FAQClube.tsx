...
/**
 * Clone da FAQSection da homepage para /clube.
 * Tab "Clube de Assinaturas" vem primeiro, expandida com as perguntas do
 * blueprint. Clube = créditos/dias de uso — nunca "corte ilimitado".
 * Migração nunca cravada: sempre como conversa com o time.
 */
const faqItems: FAQItem[] = [
  // Clube de Assinaturas (tab primeira, expandida)
  {
    category: "Clube de Assinaturas",
    question: "Como funciona o Clube de Assinaturas?",
    answer:
      "Você cria planos recorrentes por créditos (ex.: 4 cortes por mês) ou por dias de uso, e o cliente assina direto pelo app da sua barbearia. A cobrança se repete automaticamente e o sistema controla o que cada assinante pode usar no período. Isso gera receita previsível e fideliza o cliente.",
  },
  {
    category: "Clube de Assinaturas",
    question: "Posso criar diferentes tipos de planos de assinatura?",
    answer:
      "Sim! Você pode criar planos por créditos ou por dias de uso, incluir serviços diferentes em cada plano e definir preços diferenciados. Os planos ficam ajustáveis no painel — você muda preço e regras quando precisar.",
  },
  {
    category: "Clube de Assinaturas",
    question: "E se o assinante quiser usar demais?",
    answer:
      "Cada plano tem uma regra clara: por créditos, o assinante usa o número de serviços contratado no período; por dias de uso, o plano define em quantos dias ele pode ser atendido. O sistema controla isso automaticamente — sem conta de cabeça e sem discussão na recepção.",
  },
  {
    category: "Clube de Assinaturas",
  ...
  },
  {
    ...
    answer:
      "Os pagamentos são processados automaticamente pelo Asaas, parceiro de pagamentos integrado ao sistema, e o valor é creditado na sua conta. Você pode acompanhar o extrato de recebimentos, faturas previstas e fazer saques diretamente pelo sistema.",
  },
  {
    category: "Clube de Assinaturas",
...
// Get unique categories (ordem de aparição: Clube primeiro)
        ...
        >
          <ChevronDown
            className={`w-4 h-4 transition-colors ${
              isOpen
                ? "text-[#ffaf02]"
                : "text-gray-400 group-hover:text-[#ffaf02]"
            }`}
          />
        </div>
      </button>
      ...
      <div className="container-custom">
        ...
        <div className="text-center mb-10 md:mb-14 animate-fade-in-up">
          ...
          <p className="text-sm md:text-base text-gray-400 max-w-xl mx-auto">
            Tire suas dúvidas sobre o clube de assinaturas e o BestBarbers
          </p>
        </div>

        {/* Category Tabs - Horizontal scroll on mobile */}
        <div
          className="relative mb-8 md:mb-10 animate-fade-in-up"
          style={{ animationDelay: "0.1s" }}
        >
          {/* Left gradient fade */}
          <div
            className={`absolute left-0 top-0 bottom-0 w-8 bg-gradient-to-r from-[#121212] to-transparent z-10 pointer-events-none transition-opacity duration-300 md:hidden ${
          ...
          {/* Right gradient fade */}
          <div
            className={`absolute right-0 top-0 bottom-0 w-8 bg-gradient-to-l from-[#0f0f0f] to-transparent z-10 pointer-events-none transition-opacity duration-300 md:hidden ${
