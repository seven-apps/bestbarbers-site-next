...
interface FuncionalidadesClubeProps {
  onCtaClick: () => void;
}

/**
 * Clone da FeaturesSection da homepage para /clube.
 * Headline "O clube na frente, o sistema completo atrás";
 * grid dos 12 itens igual à home. originDesc: [Site-Clube]BT-Funcionalidades.
 */
export function FuncionalidadesClube({ onCtaClick }: FuncionalidadesClubeProps) {
  const { features } = clubeContent;
