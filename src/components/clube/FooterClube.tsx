...
/**
 * Clone do Footer da homepage para /clube — igual ao da home,
 * com a linha extra "Quer conversar sobre a migração do seu clube?
 * Chama no WhatsApp."
 */
export function FooterClube() {
  const { footer } = homeContent;
  const { migracao } = clubeContent.footer;
  ...
  return (
    <footer className="bg-[#0a0a0a] py-16 md:py-20 lg:py-24 overflow-hidden border-t border-white/5">
      <div className="container-custom">
        ...
        {/* Linha de migração do clube (exclusiva da /clube) */}
        <motion.div
        ...
        >
          <p className="text-center text-sm md:text-base text-gray-400">
            ...
            <Link
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="text-[#ffaf02] font-semibold hover:underline"
            >
              {migracao.ctaText}
            </Link>
          </p>
