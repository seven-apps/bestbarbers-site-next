...
interface AssinaturasClubeProps {
  onCtaClick: () => void;
}

/**
 * Clone da SubscriptionsSection da homepage para /clube.
 * Mesmo mockup real + selo Asaas; headline focada na cobrança.
 * originDesc: [Site-Clube]BT-Assinatura.
 */
export function AssinaturasClube({ onCtaClick }: AssinaturasClubeProps) {
  const { subscriptions } = clubeContent;
