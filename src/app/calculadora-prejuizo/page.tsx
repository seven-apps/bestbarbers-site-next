...
function CalculadoraContent() {
  ...
  useEffect(() => {
    trackCustomEvent("ViewContent", {
      content_name: "Calculadora de Prejuízo",
  ...
  return (
    <>
      ...
      {/* 1. Hero — promessa: descubra quanto perde */}
      ...
      {/* 3. Captura de lead — CTA "Quero recuperar isso" leva até aqui */}
      <FormSectionCalc />

      {/* 4. FAQ — transparência sobre os números (regra de veracidade) */}
      <FAQCalc />
...
export default function CalculadoraPrejuizoPage() {
  return (
    <main
