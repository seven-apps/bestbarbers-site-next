...
export const metadata: Metadata = {
  ...
  description:
    "Descubra em 1 minuto quanto sua barbearia deixa de faturar por mês sem clube de assinaturas. Calculadora gratuita da BestBarbers — mais de 51.000 assinantes ativos em mais de 1.200 barbearias na plataforma.",
  alternates: {
