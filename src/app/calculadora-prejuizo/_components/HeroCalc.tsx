      ...
      <div className="container-custom relative z-10">
        <div className="max-w-3xl mx-auto text-center flex flex-col items-center">
          ...
          >
            ...
            Mais de {PROVA.assinantesAtivos.toLocaleString("pt-BR")} assinantes ativos em mais de{" "}
            {PROVA.barbearias.toLocaleString("pt-BR")} barbearias na plataforma BestBarbers
          </p>
