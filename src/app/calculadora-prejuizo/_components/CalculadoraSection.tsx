        ...
        >
          <div className="flex items-start gap-2.5">
            ...
            >
              ...
              esta é uma <strong>projeção</strong>, não um dado ao vivo da sua base. Ela combina os
              números que você informou acima com uma <strong>premissa nossa</strong>: um plano de
              clube de <strong>{brl(PROVA.ticketAssinante)}/mês</strong>. Se o seu plano tiver outro
              preço, o resultado muda na mesma proporção. As porcentagens de recorrência e de conversão
              para o clube também são premissas suas — ajuste os sliders para refletir o seu cenário.
            </p>
          </div>
        </div>
      </div>
