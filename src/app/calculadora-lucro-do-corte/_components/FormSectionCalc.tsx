...
function getFormHeading(utmContent: string | null) {
  ...
  if (content.includes("prejuizo") || content.includes("perde") || content.includes("perdendo"))
    return { lead: "Quero parar de", highlight: "trabalhar no prejuízo" };
  if (content.includes("preco") || content.includes("preço") || content.includes("margem"))
    return { lead: "Quero acertar o preço", highlight: "e a margem de cada corte" };
  if (content.includes("comissao") || content.includes("comissão") || content.includes("custo"))
    return { lead: "Quero enxergar", highlight: "o custo real de cada corte" };
  return { lead: "Quero esse número certo", highlight: "o mês inteiro, no automático" };
}
    ...
    >
      ...
      >
        ...
        <div className="px-6 md:px-10 py-10 md:py-12 flex flex-col items-center">
          ...
          >
            Deixe seu contato e um especialista monta com você o preço, a comissão e a
            gestão pra esse lucro por corte se manter o mês inteiro.
          </p>
