    ...
    >
      ...
      <div className="container-custom relative z-10">
        <div className="max-w-3xl mx-auto text-center flex flex-col items-center">
          ...
          >
            Faturamento não é lucro. O corte só te dá dinheiro depois que você desconta
            produto, comissão e a fatia do aluguel. Descubra, em 1 minuto, quanto sobra
            de verdade em cada corte — ou se você está trabalhando no prejuízo sem saber.
          </p>
          <p
          ...
          >
            <Scissors className="w-4 h-4" style={{ color: "#ebad04" }} />
            Você coloca os seus números — a conta é 100% sua, nada é inventado
          </p>
