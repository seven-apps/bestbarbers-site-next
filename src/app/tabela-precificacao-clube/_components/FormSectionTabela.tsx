...
import { ArrowRight, ShieldCheck, Users2, BadgeDollarSign } from "lucide-react";
...
const formFields = [
  ...
  // Idêntico ao braço gated (FormModalTabelaGated.tsx): os dois são o mesmo A/B, e mudar
  // só um dos lados contaminaria a leitura do teste.
...
export function FormSectionTabela() {
  ...
  const goToStep2 = () => {
    ...
    if (!avancoMedido.current) {
      ...
      trackAvancoPasso2({
        lpVersion: "tabela_precificacao_clube",
