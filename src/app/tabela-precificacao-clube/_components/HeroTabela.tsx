...
interface HeroTabelaProps {
  onCtaClick?: () => void;
}

export function HeroTabela({ onCtaClick }: HeroTabelaProps) {
  return (
    <section
      ...
      <div className="container-custom relative z-10">
        <div className="max-w-3xl mx-auto text-center flex flex-col items-center">
          ...
          >
            <span
              className="block"
              style={{ fontSize: "clamp(32px, 6.5vw, 56px)", fontWeight: 800 }}
            >
              Tabela de Precificação
            </span>
            <span
              className="block mt-1"
              style={{ fontSize: "clamp(32px, 6.5vw, 56px)", fontWeight: 800, color: "#ebad04" }}
            >
          ...
          >
            O erro que mata clube de assinatura é o preço chutado. Arraste os botões com o valor
            do seu corte, suas cadeiras e a comissão — e veja a mensalidade recomendada, a margem
            da barbearia e o ganho real do seu barbeiro. Sem matemática complexa.
          </p>
          <p
