...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "/tabela-precificacao-clube-gated",
  },
  // Variante A/B — não indexar (o canônico de produção é /tabela-precificacao-clube).
  ...
  openGraph: {
    ...
    url: "https://www.bestbarbers.app/tabela-precificacao-clube-gated",
    type: "website",
    locale: "pt_BR",
...
export default function TabelaPrecificacaoClubeGatedLayout({
  children,
}: {
