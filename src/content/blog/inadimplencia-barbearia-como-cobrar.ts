...
export const inadimplenciaBarbearia: BlogArticle = {
  slug: "inadimplencia-barbearia-como-cobrar",
  title: "Inadimplência em Barbearia: Como Cobrar o Assinante Sem Criar Atrito",
  description:
  ...
  keywords: [
    "inadimplência barbearia como cobrar",
    "inadimplência barbearia",
    "cobrança assinante barbearia",
    "régua de cobrança barbearia",
    "como cobrar cliente barbearia whatsapp",
    "clube de assinatura inadimplência",
    "retenção assinante barbearia",
    "cobrança automática barbearia",
  ],
  ...
  sections: [
    ...
    // =========================================================================
    {
      ...
      blocks: [
        ...
        {
          type: "paragraph",
          text: "Multiplique esse ticket médio pela quantidade de assinantes que falham e seguem vindo. Em uma base de 200 ou 300 assinantes, mesmo um punhado de cobranças que não passaram por mês representa, ao longo de um ano, milhares de reais prestados de graça. É dinheiro que já era seu — você só não foi avisado de que ele não entrou.",
        },
      ],
    },

    // =========================================================================
    // SECTION 3 — Régua de cobrança
    // =========================================================================
    {
      heading: "A régua de cobrança sem criar atrito: D-5, D+1 e D+7",
      blocks: [
        {
          type: "paragraph",
          text: "A melhor cobrança é a que acontece antes do problema. Uma régua de cobrança bem montada não espera o cliente ficar inadimplente para agir — ela trabalha em três momentos: antes do vencimento, logo depois da falha e na confirmação de que algo precisa mudar. O nome técnico é \"régua de comunicação\", e a lógica é simples: cada toque tem um objetivo diferente e um tom diferente. Vamos ao desenho que funciona para barbearias.",
        },
        {
          type: "subheading",
          text: "D-5: o lembrete preventivo (cinco dias antes do vencimento)",
        },
        {
          type: "paragraph",
        ...
        {
          type: "subheading",
          text: "D+1: o aviso de falha (um dia depois do vencimento)",
        },
        {
          type: "paragraph",
        ...
        {
          type: "subheading",
          text: "D+7: o último lembrete antes da decisão",
        },
        {
          type: "paragraph",
          text: "Uma semana depois, se ainda não houve pagamento, o tom muda — continua respeitoso, mas agora informa que o acesso ao clube será suspenso se a pendência não for resolvida. Esse toque cria a urgência necessária sem agredir. É aqui que você separa o esquecimento (resolvido em segundos) da real falta de interesse. A grande maioria dos casos legítimos já se resolveu no D+1; o D+7 é a rede de segurança.",
        },
        {
          type: "callout",
          text: "A régua D-5 · D+1 · D+7 transforma cobrança em comunicação. O cliente nunca é pego de surpresa, você nunca vira cobrador, e o dinheiro entra antes de virar prejuízo. O segredo é a constância — toda cobrança, todo cliente, sem exceção e sem você precisar lembrar.",
        },
        {
          type: "link-box",
          title: "Quanto a inadimplência está custando à sua barbearia?",
    ...
    // =========================================================================
    // SECTION 4 — O que dizer no WhatsApp
    // =========================================================================
    {
      heading: "O que dizer no WhatsApp: roteiro real de cobrança",
      blocks: [
        {
          type: "paragraph",
          text: "A diferença entre uma mensagem que cobra e uma que afasta está em três coisas: o tom, a clareza do próximo passo e a ausência de julgamento. O cliente precisa entender em segundos o que aconteceu e o que fazer — sem se sentir acusado. Abaixo estão roteiros reais que você pode adaptar para a voz da sua barbearia. A regra de ouro: trate como se fosse um favor que você está fazendo ao cliente, não uma dívida que você está cobrando.",
        },
        {
          type: "subheading",
          text: "Mensagem D-5 (lembrete preventivo)",
        },
        {
          type: "paragraph",
          text: "\"Fala, Marcos! Tudo certo? Passando só pra avisar que sua renovação do clube cai daqui a 5 dias. Se o cartão tiver mudado ou vencido, dá pra atualizar rapidinho por aqui pra não dar nenhum perrengue. Qualquer coisa, é só chamar. Abraço!\"",
        },
        {
          type: "subheading",
          text: "Mensagem D+1 (aviso de falha — a mais importante)",
        },
        {
          type: "paragraph",
          text: "\"Opa, Marcos! Tudo bem? A cobrança do seu clube não passou agora — geralmente é só o cartão que venceu ou o limite que travou, acontece bastante. Não quero que você fique sem o acesso à toa, então deixei o link aqui pra você resolver em 1 minutinho: [link]. Qualquer dúvida me chama!\"",
        },
        {
          type: "paragraph",
          text: "Repare no que essa mensagem faz: ela normaliza o problema (\"acontece bastante\"), tira o peso da culpa (\"geralmente é só o cartão\"), explica que é do seu interesse que ele continue (\"não quero que você fique sem acesso\") e entrega o próximo passo pronto (o link). O cliente não precisa pensar em nada — só clicar. Essa é a estrutura que converte cobrança em ação sem gerar constrangimento.",
        },
        {
          type: "subheading",
          text: "Mensagem D+7 (último lembrete antes de suspender)",
        },
        {
          type: "paragraph",
          text: "\"Marcos, tudo bem? Sua mensalidade do clube ainda está em aberto desde o dia [X]. Pra não precisar pausar seu acesso, é só regularizar por aqui: [link]. Se estiver passando por algum aperto ou quiser conversar sobre o plano, me avisa que a gente dá um jeito juntos. Mas precisei te avisar que, sem o pagamento, o acesso será suspenso a partir de [data].\"",
        },
        {
          type: "paragraph",
          text: "Essa mensagem equilibra firmeza e humanidade. Ela informa a consequência real (suspensão) com data, mas abre uma porta para o diálogo (\"se estiver passando por um aperto, a gente dá um jeito\"). Isso é importante porque, no raro caso de dificuldade financeira genuína, oferecer uma pausa ou um plano menor retém o cliente — enquanto uma cobrança seca o empurra para o cancelamento e para a concorrência.",
        },
        {
          type: "list",
          ordered: false,
    ...
    // =========================================================================
    {
      ...
      blocks: [
        ...
        {
          type: "subheading",
          text: "App próprio como canal direto",
        },
        {
          type: "paragraph",
          text: "Quando o cliente tem o app da sua barbearia no celular, atualizar o cartão vencido vira um toque na tela — sem WhatsApp, sem link perdido, sem fricção. O app também é onde o assinante vê seus créditos, recebe os lembretes da régua como notificação e regulariza pendências na hora. Reduzir o atrito do pagamento é a forma mais elegante de reduzir a inadimplência: muita falha não é falta de vontade de pagar, é dificuldade de pagar.",
        },
        {
          type: "link-box",
        ...
        {
          type: "paragraph",
          text: "É essa combinação — cobrança automática, painel visível e app de baixo atrito — que sustenta clubes saudáveis. Um exemplo concreto de quem opera nessa lógica: uma barbearia de 3 cadeiras em Araxá/MG mantém 290 assinantes ativos e R$27.586 de receita recorrente por mês. Manter uma base desse tamanho com inadimplência sob controle no braço, manualmente, seria inviável. É a automação da régua que torna esse patamar sustentável — e o dono fica livre para cuidar do que importa: a cadeira e o cliente.",
        },
        {
          type: "highlight",
        ...
        {
          type: "paragraph",
          text: "Veja como o BestBarbers automatiza a cobrança do seu clube de assinaturas, com régua de comunicação, painel de inadimplência e app próprio — a partir de R$299/mês. É a diferença entre um clube que parece dar dinheiro e um clube que efetivamente entra na conta todo mês.",
        },
      ],
    },
  ],
  ...
  faq: [
    {
      question: "Como cobrar um assinante inadimplente sem parecer grosso?",
      answer:
    ...
    {
      question: "O que é uma régua de cobrança e como montar para barbearia?",
      answer:
    ...
    {
      question: "Por que a maioria da inadimplência no clube não é má-fé?",
      answer:
    ...
    {
      question: "Quando devo suspender o acesso de um assinante que não paga?",
      answer:
    ...
    {
      question: "Vou perder clientes se cobrar a mensalidade atrasada?",
      answer:
    ...
    {
      question: "Como evitar que a cobrança dependa de eu lembrar todo mês?",
      answer:
    ...
    {
      question: "Quanto a inadimplência silenciosa custa para a barbearia?",
      answer:
  ...
  // Related
  // ===========================================================================
  relatedSlugs: ["gestao-financeira-barbearia", "clube-assinatura-barbearia"],
  relatedFeatures: [
    {
      title: "Gestão Financeira",
      href: "/gestao-financeira-barbearia",
      description:
        "Controle receitas, pendências e a inadimplência do clube em um painel único, com cobrança recorrente automatizada.",
    },
    {
      title: "Clube de Assinaturas",
      href: "/clube-de-assinaturas",
      description:
        "Crie planos, automatize a cobrança e acompanhe pagamentos, pendências e churn com painel completo.",
    },
    {
      title: "App Próprio",
      href: "/app-proprio-barbearia",
      description:
        "Um aplicativo com a marca da sua barbearia para o assinante atualizar o cartão e regularizar pagamentos com um toque.",
    },
  ],
};
