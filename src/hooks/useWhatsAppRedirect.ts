...
export const useWhatsAppRedirect = () => {
  ...
  const redirectToWhatsApp = useCallback(
    (customMessage?: string) => {
      ...
      const baseLink = `https://wa.me/${WHATSAPP_NUMBER}?text=${
        customMessage || BASE_MESSAGE
      }`;
      ...
      const messageMap: { [key: string]: string } = {
        ...
        octos:
          baseLink +
          "%0AConheci%20através%20do%20Pedro%20da%20barbearia%20Octos",
        "james-imersao":
          baseLink + "%0AConheci%20através%20da%20Imersão%20do%20James",
        rayslander:
          baseLink +
        ...
        "robson-contador":
          baseLink + "%0AConheci%20através%20do%20Robson%20Contador",
        ...
        "thais-dantunes":
          baseLink + "%0AConheci%20através%20da%20Thais%20D'Antunes",
        "david-champs":
          baseLink + "%0AConheci%20através%20do%20David%20Champs",
        gladstone:
          baseLink + "%0AConheci%20através%20do%20Gladstone",
        billy:
          baseLink + "%0AConheci%20através%20do%20Billy%20Tribos",
        gilberto:
        ...
        "joao-seletto":
          baseLink + "%0AConheci%20através%20do%20João%20Seletto",
        ottoni:
          baseLink + "%0AConheci%20através%20do%20Ottoni",
        "rafael-guapo":
          baseLink + "%0AConheci%20através%20do%20Rafael%20Guapo",
      };
